...
pub(crate) enum LifecycleFaultPoint {
    ...
    BackupStagingCreated,
    BackupDataCopied,
    BackupManifestSynced,
    BackupStagingKept,
    BackupPublished,
    ...
    SourceImportPublicationPrepared,
    SourceImportBeforePublicationRecorded,
    SourceImportBeforePublicationOwnershipRecorded,
