...
- Evidence refresh: 2026-09-03; all 67 direct GitHub repositories and the applicable direct non-GitHub release pages were rechecked during this campaign. RomM authority was confirmed as version 5.2.0 with host `/volume1/media/roms` mounted read-only at `/romm/library`. GitHub release checks used Portcove's normal resolver and fail-closed checksum rules.
