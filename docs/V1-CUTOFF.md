...
| Shared-source adapters | OpenGOAL: Jak and Daxter, Jak II, and Jak 3 | reviewed upstream-managed data setup per title | Cataloged as three direct-upstream ports; v0.3.6 Windows packages install and verify; all available No Debug-patched CHDs are correctly rejected by the pinned extractor and deferred per game |
