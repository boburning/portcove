...
The final owned-library handoff scenario moves the harness's copied library through
Settings. It checks preserved originals, matching saved-data copies, stable active
