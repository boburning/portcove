...
This revision supports **Portcove API schemas 42–45 and event schema 2**. Additional
...
string is not used as a compatibility guess. Use an exactly identified schema-42, schema-43, schema-44 or schema-45
