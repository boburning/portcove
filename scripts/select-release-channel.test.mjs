...
const releases = [
  { tag_name: "v2.0.0-beta.2", draft: false, prerelease: true, published_at: "2026-09-05T12:00:00Z" },
  { tag_name: "v2.0.0-beta.3", draft: true, prerelease: true, published_at: "2026-09-06T12:00:00Z" },
  { tag_name: "v1.5.0", draft: false, prerelease: false, published_at: "2026-08-01T12:00:00Z" },
  { tag_name: "v2.0.0-beta.1", draft: false, prerelease: true, published_at: "2026-09-01T12:00:00Z" },
];
...
test("rejects a published channel candidate without a trustworthy publication timestamp", () => {
  const malformed = [{ tag_name: "v2.0.0-beta.4", draft: false, prerelease: true, published_at: "not-a-date" }];
