...
import { loadPackagePolicy, releaseLabels as policyReleaseLabels } from "./release-package-policy.mjs";
...
test("publisher waits for every builder and reconciles before draft mutation", () => {
  ...
  assert.match(publishSection, /gh release create "\$RELEASE_TAG"[\s\S]*--notes-file release-metadata\/generated-release-body\.md/);
