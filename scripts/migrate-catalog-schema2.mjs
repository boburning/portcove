...
const evidence = [
  ...
  },
  {
    ...
    reviewed_at: "2026-09-05",
    claim:
      "Distinguishes the supported raw MODE2/2352 disc image from its cooked 2048-byte ISO representation",
    immutable_url: `https://github.com/TechnicallyComputers/BombermanPartyEditionRecomp/blob/${bombermanRef}/DISC.md`,
    live_url:
      "https://github.com/TechnicallyComputers/BombermanPartyEditionRecomp/blob/main/DISC.md",
  },
  upstreamEvidence(
    reviewedSources.ghostship,
    "Lists the Japanese and US Super Mario 64 sources accepted by Ghostship 2.0.0",
  ),
  upstreamEvidence(
    reviewedSources.lighthouse,
    "Lists the US 1.0, US 1.1, PAL, and Japanese Banjo-Kazooie sources accepted by Lighthouse 1.1.0",
  ),
  upstreamEvidence(
    reviewedSources.shipwright,
    "Lists the Ocarina of Time sources accepted by Ship of Harkinian 9.2.3",
  ),
  upstreamEvidence(
    reviewedSources.twoShip,
    "Lists the Majora's Mask NTSC-U 1.0 and GameCube sources accepted by 2Ship2Harkinian 5.0.1",
  ),
  upstreamEvidence(
    reviewedSources.starship,
    "Lists the compressed and decompressed US 1.0 and US 1.1 Star Fox 64 sources accepted by Starship 2.0.0",
  ),
  upstreamEvidence(
    reviewedSources.banjoRecomp,
    "Limits Banjo: Recompiled 1.0.2 to the North American 1.0 Banjo-Kazooie source",
  ),
  upstreamEvidence(
  ...
  {
    id: "revelations-persona-recompiled-windows-reinstall-2026-09-15",
    role: "portcove_qualification",
    authority: "boburning/portcove",
    authority_ref: "ffee8733e4448b8fbc8fe357ebdf77252a6260e8",
    reviewed_at: "2026-09-15",
    claim:
      "Records exact Windows v0.1.1 managed removal, clean reinstall, canonical configuration preservation, generated-copy restoration, and immutable verification evidence",
    immutable_url:
      "https://github.com/boburning/portcove/blob/ffee8733e4448b8fbc8fe357ebdf77252a6260e8/docs/qualification/revelations-persona-recompiled-windows-reinstall-2026-09-15.md",
    live_url:
      "https://github.com/boburning/portcove/blob/main/docs/qualification/revelations-persona-recompiled-windows-reinstall-2026-09-15.md",
  },
  {
...
function representation(profile) {
  ...
  if (profile.kind === "psx-disc") {
    ...
    return {
      ...
      evidence_ids:
        profile.id === "bomberman-party-edition-psx"
  ...
  if (!identities.length) {
    return {
      ...
      evidence_gap:
        "Schema 1 admits this source by extension and structural checks without deterministic identity evidence.",
      evidence_ids: [portcoveEvidence],
    };
  }
  ...
  return {
    ...
    kind:
      profile.kind === "file-set"
        ? "file-set"
        : profile.kind === "gamecube-disc" ||
            profile.kind === "psx-disc" ||
            profile.kind === "upstream-validated-disc"
          ? "optical-disc"
          : profile.id === "sotn-xbla"
            ? "compound"
            : "file",
    variants: [
      {
...
function n64Variant(id, title, region, revision, hashes, evidenceId, representations) {
  return {
    ...
    representations: representations ?? [
      canonicalN64Representation("canonical-rom", hashes, evidenceId),
    ],
    evidence_ids: [evidenceId],
  };
}
...
const shipwrightHashes = [
  ...
  [
    ...
    "PAL Master Quest Debug",
    "PAL",
    "Master Quest Debug 1",
  ...
  [
    ...
    "NTSC GameCube (JP) Collector's Edition",
    "Japan",
...
personaContract.authority_ref = "ffee8733e4448b8fbc8fe357ebdf77252a6260e8";
  ...
  source_catalog: {
    ...
    qualification: [
      ...
      },
      {
        ...
        kind: "automated_lifecycle",
        outcome: "passed",
        observed_at: 1789524300,
        portcove_version: "0.1.0-alpha.2",
        portcove_commit: "6348bf3e80edf079eb8b12383bf4a8635a380def",
        method:
          "Exact v0.1.1 fresh install and verification, responsive launcher, managed removal, canonical configuration preservation, clean reinstall with a new identity, generated runtime-copy restoration, final 2,094-file verification, and healthy backup",
        evidence_ids: ["revelations-persona-recompiled-windows-reinstall-2026-09-15"],
      },
      {
        scope: {
