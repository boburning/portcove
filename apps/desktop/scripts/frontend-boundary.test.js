...
function inspect(
  ...
  try {
    ...
    mkdirSync(path.join(root, "src/features/installation"), { recursive: true });
    writeFileSync(
    ...
    writeFileSync(path.join(root, "src/features/installation/model.ts"), featureSource);
...
it.each([
  ...
  'export { value } from "../features/installation/model";',
