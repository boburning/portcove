...
export const desktopApi = {
  ...
  restoreBackup: (portId: string, backupId: string, expectedPreview: string, generation: number) => invoke<RestoreResult | null>("restore_backup", { portId, backupId, expectedPreview, generation }),
  deleteBackup: (portId: string, backupId: string, expectedPreview: string, generation: number) => invoke<BackupRecord | null>("delete_backup", { portId, backupId, expectedPreview, generation }),
  ...
  previewSourceRemoval: (profileId: string, generation: number) => invoke<SourceRemovalPreview>("preview_source_removal", { profileId, generation }),
  removeSource: (profileId: string, previewSha256: string, generation: number) => invoke<SourceRemovalPreview | null>("remove_source", { profileId, previewSha256, generation }),
