...
export function FailureDetails({ presentation, code }: { presentation: FailureDisplay; code?: string }) {
  ...
  return <div className="failure-details">
    <p>{Object.hasOwn(outcomes, presentation.mutation_state) ? outcomes[presentation.mutation_state as Presentation["mutation_state"]] : outcomes.unknown}</p>
