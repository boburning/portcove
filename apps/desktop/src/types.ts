...
export type ReadinessBlocker = NonNullable<
  PortStatus["readiness"]
>["blockers"][number];
...
export type ActivityDiagnostic =
  Generated.TransportOutputs["activity_diagnostic"];

export type { StorageSummary } from "./transport-types.generated";

export type { HostToolStatus } from "./transport-types.generated";

export type HostToolProbeResult =
  Generated.TransportOutputs["host_tool_probe_result"];
...
export type SourceRemovalPreview =
  Generated.TransportOutputs["source_removal_preview"];
...
export type SourceIntakeInspection =
  Generated.TransportOutputs["source_intake_inspection"];
...
export type OutputDestinationPreview =
  Generated.TransportOutputs["output_destination_preview"];

export type OutputRelocationPlan =
  Generated.TransportOutputs["output_relocation_plan"];

export type OutputRelocationResult =
  Generated.TransportOutputs["output_relocation_result"];

export type OutputRelocationStatus =
  Generated.TransportOutputs["output_relocation_status"];
...
export type UpdateCheckOutcome =
  Generated.TransportOutputs["desktop_update_check_outcome"];
...
export type BootstrapStatus =
  Generated.TransportOutputs["desktop_bootstrap_status"];
...
export type LibraryMoveResult =
  Generated.TransportOutputs["library_move_result"];

export type LibraryImportPlan =
  Generated.TransportOutputs["library_import_plan"];

export type LibraryImportResult =
  Generated.TransportOutputs["library_import_result"];

export type SourceDiscoveryLimits =
  Requests.TransportInputs["source_discovery_limits"];

export type SourceDiscoveryRequest =
  Requests.TransportInputs["source_discovery_request"];

export type SourceDiscoveryReport =
  Generated.TransportOutputs["source_discovery_report"];

export type SourceInboxPaths = Generated.TransportOutputs["source_inbox_paths"];

export type SourceInboxResolution =
  Generated.TransportOutputs["source_inbox_resolution"];
...
export type SourceImportResult =
  Generated.TransportOutputs["source_import_result"];

export type GithubAuthStatus = Generated.TransportOutputs["github_auth_status"];

export type GithubDeviceLogin =
  Generated.TransportOutputs["github_device_login"];

export type GithubDeviceLoginResult =
  Generated.TransportOutputs["github_device_login_result"];

export type CatalogUpdateSource =
  Requests.TransportInputs["catalog_update_source"];

export type CatalogProvenance =
  Generated.TransportOutputs["catalog_provenance"];

export type CatalogStatus = Generated.TransportOutputs["catalog_status"];

export type CatalogUpdatePlan =
  Generated.TransportOutputs["catalog_update_plan"];
...
export type PortRemovalPreview =
  Generated.TransportOutputs["port_removal_preview"];

export type CliCommandContext =
  Generated.TransportOutputs["desktop_cli_command_context"];
